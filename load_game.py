    ...
    if game.MainMenu is not None:
        ...
        if save_file:
            ...
            with open(directory, "r", encoding="utf-8") as f:
                ...
                xp_gained = f.readline().strip()  # Amount of xp gained (one single number)
                # Player relationships (one line, multiple numbers) (see player.py for more info)
                player_relationships = f.readline().strip()
            ...
            if current_chapter == "":
                ...
                os.remove(directory)
                print(Fore.RED, "Save file is corrupted. Please start a new game.", Fore.RESET)
                print(Fore.RED, "Error Message: Missing Player Relationships", Fore.RESET)
        ...
        print(Fore.RED, "Error: MainMenu is not defined", Fore.RESET)
